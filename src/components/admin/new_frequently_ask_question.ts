...
const Store = {
    ...
    save: function() {
        ...
        m.request(AppSettings.API_BASE_URL + "/api/frequently-ask-question/", {
            method: "POST",
            data: data,
            headers: {
            ...
            if (res.success) {
                Utils.showSnackbar("Successfully created new faq. This will redirect after 3 seconds.");
                setTimeout(function() {
                    m.route.set("/admin/view-frequently-ask-question-list");
                }, 3000);
            } else {
